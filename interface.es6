(function () {
    ...
    class DOMCreate {
        ...
        set createButton(name, className, callback, styles) {
            name = name || "Click Me";
            this.buttonNumber += 1;
            this.marginTop += 100;
        ...
        createDIVLog(txt, className, styles) {
    ...
    let testp = new testPromise();
    dom.createDIVLog("prêt à commencer le test", "log");
    dom.createButton("testor", "btn-", testp);
